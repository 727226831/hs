...
public class DataBinderMapperImpl extends DataBinderMapper {
  ...
  private static final int LAYOUT_ACTIVITYPRINT = 3;

  private static final int LAYOUT_ACTIVITYPRODUCTIONWAREHOUSING = 4;

  private static final int LAYOUT_ACTIVITYSTOCKCHECK = 5;

  private static final int LAYOUT_ITEMDETAILLIST = 6;

  private static final int LAYOUT_ITEMDISPATCHDETAILS = 7;

  private static final int LAYOUT_ITEMINPUT = 8;

  private static final int LAYOUT_ITEMPRODUCTIONLIST = 9;

  private static final int LAYOUT_ITEMSTOCKCHECK = 10;
