...
public class ItemDispatchdetailsBindingImpl extends ItemDispatchdetailsBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.tv_irowno, 4);
        sViewsWithIds.put(R.id.tv_bWhPos, 5);
        sViewsWithIds.put(R.id.tv_cinvcode, 6);
    ...
    public ItemDispatchdetailsBindingImpl(@Nullable android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 10, sIncludes, sViewsWithIds));
    }
    private ItemDispatchdetailsBindingImpl(android.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
